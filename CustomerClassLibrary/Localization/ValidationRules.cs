namespace CustomerClassLibrary.Localization
{
	public static class ValidationRules
	{
		...
		public const string PERSON_FIRST_NAME_WHITESPACE = "First name cannot consist of whitespace characters.";
		...
		public const string PERSON_LAST_NAME_WHITESPACE = "Last name cannot consist of whitespace characters.";
		...
		public const string CUSTOMER_PHONE_NUMBER_WHITESPACE = "Phone number cannot contain whitespace characters.";
		public const string CUSTOMER_PHONE_NUMBER_FORMAT = "Phone number: must be in {0} format.";

		public const string CUSTOMER_EMAIL_WHITESPACE = "Email cannot contain whitespace characters.";
		...
		public const string CUSTOMER_NOTES_TEXT_NULL_EMPTY_OR_WHITESPACE = "Notes cannot be empty or consist of whitespace characters.";
		...
		public const string ADDRESS_LINE_WHITESPACE = "Address line cannot consist of whitespace characters.";
		public const string ADDRESS_LINE_MAX_LENGTH = "Address line: max {0} characters.";

		public const string ADDRESS_LINE2_WHITESPACE = "Address line2 cannot consist of whitespace characters.";
		...
		public const string ADDRESS_CITY_WHITESPACE = "City cannot consist of whitespace characters.";
		...
		public const string ADDRESS_POSTAL_CODE_WHITESPACE = "Postal code cannot consist of whitespace characters.";
		...
		public const string ADDRESS_STATE_WHITESPACE = "State cannot consist of whitespace characters.";
		...
		public const string ADDRESS_COUNTRY_WHITESPACE = "Country cannot consist of whitespace characters.";
